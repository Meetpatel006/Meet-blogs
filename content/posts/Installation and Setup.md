...
- Obsidian is the BEST notes application in the world. Go download it: [Obsidian](https://obsidian.md/)
...
!![Image Description](/images/Image%2020241203184321.png)
...
- Install Git: [Git](https://github.com/git-guides/install-git)
- Install Go: [Go](https://go.dev/dl/)

### Install Hugo

Link: Download the [Hugo](https://gohugo.io/installation/)
### Create a new site
...
- Find themes from this link: [Hugo Themes](https://themes.gohugo.io/)
...
# Paths
posts_dir = "/Users/Documents/content/posts/"
attachments_dir = "/Users/Documents/Attachments/"
static_images_dir = "/Users/Documents/static/images/"
...
```bash
# Step 8: Push the public folder to the Netlify branch using subtree split and force push
echo "Deploying to GitHub Netlify..."
git subtree split --prefix public -b netlify-deploy
git push origin netlify-deploy:netlify --force
...
- Drag and drop the `public` folder from your Hugo site to deploy it.
- Alternatively, link your GitHub repository and set up continuous deployment
...
# Step 8: Push the public folder to the netlify-deploy branch using subtree split and force push
...
# Push to netlify branch with force
try {
    git push origin netlify-deploy:netlify --force
} catch {
...
Write-Host "All done! Site synced, processed, committed, built, and deployed to Netlify."
```
...
# Set GitHub repo
myrepo="git@github.com:yourusername/yourrepo.git"
...
echo "All done! Site synced, processed, committed, built, and deployed to Netlify."
